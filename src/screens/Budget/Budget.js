...
import { PostCargarBudget, getDatos, getAllConceptos, getAllSecuencias, fetchPlanMensual } from '../../api/Axios';
import '../TabSequence/TabSequence.css';
...
const Budget = () => {
  ...
  const save = async (e) => {
    ...
    try {
      setLoading(true); 
      await PostCargarBudget(formData);
      setFiles([]); 
      handleClose(); 
    ...
    <div>
      ...
      <commonImports.Modal
        ...
        <commonImports.Box sx={style}>
          ...
          <span className="title-form">INGRESO DE EXCELS - BUDGET</span>
